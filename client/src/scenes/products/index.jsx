...
import { Box, Card, CardActions, CardContent, Collapse, Button, Typography, Rating, useTheme} from '@mui/material';
...
const Product = ({
    ...
    return(
        <Card sx={{backgroundImage: "none", backgroundColor: theme.palette.background.alt, borderRadius: "0.55rem"}}>
            <CardContent>
                <Typography sx={{fontSize: 14}} color={theme.palette.secondary[700]} gutterBottom={true}>
                    {category}
                </Typography>
            ...
            >
                <CardContent>
                    ...
                    <Typography>Yearly Units Sold This Year:: {stat.yearlySalesTotalSoldUnits}</Typography>
                </CardContent>
            </Collapse>
        </Card>
    )
