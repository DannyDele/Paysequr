...
const UserActivityLogPage = () => {
  ...
  const [userActivityLog, setUserActivityLog] = useState([
    { id: 1, user: 'John Doe', activity: 'Login', timestamp: '2024-03-08 10:15:30', suspicious: false, ip: '192.168.1.1' },
    { id: 2, user: 'Jane Smith', activity: 'Transaction', timestamp: '2024-03-08 11:30:45', suspicious: false, ip: '192.168.1.2' },
    { id: 3, user: 'John Doe', activity: 'Profile Update', timestamp: '2024-03-08 12:45:20', suspicious: false, ip: '192.168.1.3' },
    { id: 4, user: 'Alice Johnson', activity: 'Login', timestamp: '2024-03-08 13:20:10', suspicious: false, ip: '192.168.1.4' },
    { id: 5, user: 'Bob Williams', activity: 'Transaction', timestamp: '2024-03-08 14:55:05', suspicious: false, ip: '192.168.1.5' },
    { id: 6, user: 'John Doe', activity: 'Unauthorized Access Attempt', timestamp: '2024-03-08 15:30:10', suspicious: true, ip: '192.168.1.6' },
  ]);
    ...
    { field: 'ip', headerName: 'IP address', width: 150 },
    {
      ...
      renderCell: (params) => (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <span style={{ color: params.value ? red[500] : green[500], marginRight: '4px' }}>
            {params.value ? 'Yes' : 'No'}
          </span>
          {params.value && (
        ...
        <DialogContent>
          {selectedActivity && (
            <div>
              ...
              <Typography>IP address: {selectedActivity.ip}</Typography>
